    ...
    return (
      <form>
        <div className="form-group">
          <input type="text" readOnly className="form-control text-primary mb-1" value="Hello World" />
          <button type="button" className="btn btn-block btn-primary">Latin</button>
        </div>

        <div className="form-group">
          <input type="text" readOnly className="form-control text-danger mb-1" value="χαῖρε τὸν κόσμον" />
